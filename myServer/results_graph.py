...
# with open('C:/Non-Software/Coding_Things/Cloud_Security/dynamic-csp-generation/myServer/csp-violation.log','r') as file:
#     for line in file:
#         line = line.strip()
#         if line:
...
# plt.savefig('C:/Non-Software/Coding_Things/Cloud_Security/dynamic-csp-generation/myServer/csp_violations_by_directive.png')
# plt.show()




data = pd.read_csv('C:/Non-Software/Coding_Things/Cloud_Security/dynamic-csp-generation/myServer/load_time.csv')
...
plt.savefig('C:/Non-Software/Coding_Things/Cloud_Security/dynamic-csp-generation/myServer/page_load_times_boxplot.png')
plt.show()
